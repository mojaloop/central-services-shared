...
import RC from 'rc';
import { Headers } from '../enums/http';

const RCConfig = RC('LIB');
const defaultVersions = Headers.DEFAULT_API_VERSIONS;
...
export const resourceVersions = {
  ...defaultVersions,
  ...parseResourceVersions(RCConfig.RESOURCE_VERSIONS)
};
...
export { parseResourceVersions as __parseResourceVersions };
