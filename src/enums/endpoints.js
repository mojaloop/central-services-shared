...
const FspEndpointTypes = {
  ...
  FSPIOP_CALLBACK_URL_AUTHORIZATION_GET: 'FSPIOP_CALLBACK_URL_AUTHORIZATION_GET',
  FSPIOP_CALLBACK_URL_AUTHORIZATION_PUT: 'FSPIOP_CALLBACK_URL_AUTHORIZATION_PUT',
  FSPIOP_CALLBACK_URL_AUTHORIZATION_PUT_ERROR: 'FSPIOP_CALLBACK_URL_AUTHORIZATION_PUT_ERROR'
}
...
const FspEndpointTemplates = {
  ...
  AUTHORIZTION_GET: '/authorizations',
  AUTHORIZTION_PUT: '/authorizations/{{transactionRequestId}}',
  AUTHORIZTION_PUT_ERROR: '/authorizations/{{transactionRequestId}}/error'
}
