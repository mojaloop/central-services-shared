...
const FspEndpointTypes = {
  ...
  FSPIOP_CALLBACK_URL_PARTICIPANT_DELETE_ERROR: 'FSPIOP_CALLBACK_URL_PARTICIPANT_DELETE_ERROR',
  FSPIOP_CALLBACK_URL_PARTICIPANT_SUB_ID_DELETE_ERROR: 'FSPIOP_CALLBACK_URL_PARTICIPANT_SUB_ID_DELETE_ERROR',
