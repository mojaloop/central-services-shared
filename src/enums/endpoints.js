...
const FspEndpointTypes = {
  ...
  THIRDPARTY_CALLBACK_URL_TRANSACTION_REQUEST_POST: 'TP_CB_URL_TRANSACTION_REQUEST_POST',
  THIRDPARTY_CALLBACK_URL_TRANSACTION_REQUEST_PUT: 'TP_CB_URL_TRANSACTION_REQUEST_PUT',
  THIRDPARTY_CALLBACK_URL_TRANSACTION_REQUEST_PUT_ERROR: 'TP_CB_URL_TRANSACTION_REQUEST_PUT_ERROR',
  THIRDPARTY_CALLBACK_URL_TRANSACTION_REQUEST_AUTHORIZATIONS_POST: 'TP_CB_URL_TRANSACTION_REQUEST_AUTH_POST',
  THIRDPARTY_CALLBACK_URL_TRANSACTION_REQUEST_AUTHORIZATIONS_PUT: 'TP_CB_URL_TRANSACTION_REQUEST_AUTH_PUT',
  THIRDPARTY_CALLBACK_URL_TRANSACTION_REQUEST_AUTHORIZATIONS_PUT_ERROR: 'TP_CB_URL_TRANSACTION_REQUEST_AUTH_PUT_ERROR',
  THIRDPARTY_CALLBACK_URL_CONSENT_REQUEST_POST: 'TP_CB_URL_CONSENT_REQUEST_POST',
  THIRDPARTY_CALLBACK_URL_CONSENT_REQUEST_PUT: 'TP_CB_URL_CONSENT_REQUEST_PUT',
  THIRDPARTY_CALLBACK_URL_CONSENT_REQUEST_PUT_ERROR: 'TP_CB_URL_CONSENT_REQUEST_PUT_ERROR',
  THIRDPARTY_CALLBACK_URL_CREATE_CREDENTIAL_POST: 'TP_CB_URL_CREATE_CREDENTIAL_POST',
  THIRDPARTY_CALLBACK_URL_CONSENT_POST: 'TP_CB_URL_CONSENT_POST',
  THIRDPARTY_CALLBACK_URL_CONSENT_GET: 'TP_CB_URL_CONSENT_GET',
  THIRDPARTY_CALLBACK_URL_CONSENT_PUT: 'TP_CB_URL_CONSENT_PUT',
  THIRDPARTY_CALLBACK_URL_CONSENT_PUT_ERROR: 'TP_CB_URL_CONSENT_PUT_ERROR'
}
...
const FspEndpointTemplates = {
  ...
  THIRDPARTY_CONSENT_CREATE_CREDENTIAL_POST: '/consents/{{ID}}/createCredential',
