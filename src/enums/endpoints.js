...
const FspEndpointTypes = {
  ...
  TPP_CB_URL_AUTHORIZATIONS_POST: 'TPP_CB_URL_AUTHORIZATIONS_POST',
  TPP_CB_URL_AUTHORIZATIONS_GET: 'TPP_CB_URL_AUTHORIZATIONS_GET',
  TPP_CB_URL_AUTHORIZATIONS_PUT: 'TPP_CB_URL_AUTHORIZATIONS_PUT',
  TPP_CB_URL_AUTHORIZATIONS_PUT_ERROR: 'TPP_CB_URL_AUTHORIZATIONS_PUT_ERROR'
}
...
const FspEndpointTemplates = {
  ...
  TPP_AUTHORIZATIONS_POST: '/tppAuthorizations',
  TPP_AUTHORIZATIONS_GET: '/tppAuthorizations/{{ID}}',
  TPP_AUTHORIZATIONS_PUT: '/tppAuthorizations/{{ID}}',
  TPP_AUTHORIZATIONS_PUT_ERROR: '/tppAuthorizations/{{ID}}/error'
}
