...
declare namespace CentralServicesShared {
  ...
  interface EndPointsEnum {
    ...
    FspEndpointTypes: {
      ...
      TPP_CB_URL_ACCOUNTS_REQUEST_POST: FspEndpointTypesEnum.TPP_CB_URL_ACCOUNTS_REQUEST_POST;
      TPP_CB_URL_ACCOUNTS_REQUEST_PUT: FspEndpointTypesEnum.TPP_CB_URL_ACCOUNTS_REQUEST_PUT;
      TPP_CB_URL_ACCOUNTS_REQUEST_PUT_ERROR: FspEndpointTypesEnum.TPP_CB_URL_ACCOUNTS_REQUEST_PUT_ERROR;
      TPP_CB_URL_ACCOUNTS_REQUEST_GET: FspEndpointTypesEnum.TPP_CB_URL_ACCOUNTS_REQUEST_GET;
      TPP_CB_URL_ACCOUNTS_GET: FspEndpointTypesEnum.TPP_CB_URL_ACCOUNTS_GET;
      TPP_CB_URL_ACCOUNTS_PUT: FspEndpointTypesEnum.TPP_CB_URL_ACCOUNTS_PUT;
      TPP_CB_URL_CONSENT_REQUEST_POST: FspEndpointTypesEnum.TPP_CB_URL_CONSENT_REQUEST_POST;
      TPP_CB_URL_CONSENT_REQUEST_GET: FspEndpointTypesEnum.TPP_CB_URL_CONSENT_REQUEST_GET;
      TPP_CB_URL_CONSENT_REQUEST_PUT: FspEndpointTypesEnum.TPP_CB_URL_CONSENT_REQUEST_PUT;
      TPP_CB_URL_CONSENT_REQUEST_PATCH: FspEndpointTypesEnum.TPP_CB_URL_CONSENT_REQUEST_PATCH;
      TPP_CB_URL_CONSENT_REQUEST_PUT_ERROR: FspEndpointTypesEnum.TPP_CB_URL_CONSENT_REQUEST_PUT_ERROR;
      TPP_CB_URL_CONSENTS_POST: FspEndpointTypesEnum.TPP_CB_URL_CONSENTS_POST;
      TPP_CB_URL_CONSENTS_GET: FspEndpointTypesEnum.TPP_CB_URL_CONSENTS_GET;
      TPP_CB_URL_CONSENTS_PUT: FspEndpointTypesEnum.TPP_CB_URL_CONSENTS_PUT;
      TPP_CB_URL_CONSENTS_PUT_ERROR: FspEndpointTypesEnum.TPP_CB_URL_CONSENTS_PUT_ERROR;
      TPP_CB_URL_CONSENTS_DELETE: FspEndpointTypesEnum.TPP_CB_URL_CONSENTS_DELETE;
    };
