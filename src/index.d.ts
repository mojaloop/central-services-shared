...
declare namespace CentralServicesShared {
  ...
  interface Kafka {
    createGeneralTopicConf(template: string, functionality: string, action: string, topicNameOverride: string, key?: string, partition?: number, opaqueKey?: any,): {topicName: string, key: string | null, partition: number | null, opaqueKey: any }
  }
